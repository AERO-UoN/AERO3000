...
% 
% Modified A Bettens 2022 
% Modified B Li 2023 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

function [FlightData] = LoadFlightDataPC9()
    ...
    % Propeller Data
    FlightData.Prop.P_max = 858000; % Maximum engine power (Watts)
